...
When I push a commit to this repository, the project is automatically built (typescript compilation and Docker build) and deployed to the Google Artifact Registry. See my [GitHub workflow file](.github/workflows/google-cloud.yml) for how this is done. My recurring Google Run Job will automatically update to use the new build when it writes new articles the next morning.
